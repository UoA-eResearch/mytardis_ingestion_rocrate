...
def create_person_object(upi: str, api_agent: MyTardisRestAgent) -> Person:
    ...
    response = api_agent.mytardis_api_request(
        "GET", api_agent.api_template + users_stub + upi
    )
    ...
    #     logger.warning(
    #         "Could not find person %s in active directory, data not filled", upi
    #     )
